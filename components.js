  ...
  * {
  ...
  #pinkaru:checked ~ main .profile-wide img {
    box-shadow: 0 0 0 4px var(--secondaryShade5);
         ...
         <center><input class="variation" id="bluepurple" type="radio" value="1" name="color" checked="checked" /><label for="bluepurple"></label><input class="variation" id="sunset" type="radio" value="2" name="color" /><label for="sunset"></label><input class="variation"
   id="godiva" type="radio" value="3" name="color" /><label for="godiva"></label><input class="variation" id="dark" type="radio" value="4" name="color" /><label for="dark"></label><input class="variation" id="pinkaru" type="radio" value="5" name="color"
      ...
      <section>
          <div class="profile profile-imgonly">
              ...
              <div class="profile__info">
                  <h3>${this.mytitle}</h3>
                  <p class="profile__info__extra">texto</p>
              </div>
              <div class="profile__stats">
                  <p class="profile__stats__title">Type</p>
                  <h5 class="profile__stats__info">Fuego</h5>
              </div>
              <div class="profile__stats">
...
class SellButton2 extends HTMLElement {
    constructor() {
        super();
    }
    connectedCallback() {
     ...
     body {
       ...
       * {
       ...
       const m =[{ type: 'dragon' }, { size: '7m' }, { weight: '280kg' }];
        ...
        console.log(repeat)
        for (const iterator of JSON.parse(this.mytabla)) {
          const x =Object.keys(iterator)
          console.log(x);
          const y = iterator[x];
          console.log(y);
...
class SellButton4 extends HTMLElement {
    constructor() {
        super();
    }
    connectedCallback() {
...
class SellButton5 extends HTMLElement {
    constructor() {
        super();
    }
    connectedCallback() {
...
class SellButton6 extends HTMLElement {
    constructor() {
        super();
    }
    connectedCallback() {
...
class SellButton7 extends HTMLElement {
    constructor() {
        super();
    }
    connectedCallback() {
